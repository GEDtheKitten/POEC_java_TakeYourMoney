...
CALL P_ajouter_client ('FREYA 1', 'Le chat', 'rue du chat noir', 'Miaou', 33000, 'Bordeaux', false);
CALL P_ajouter_produit ('le carton magique', false, STR_TO_DATE('03/04/2018', '%d/%m/%Y'), 50);
CALL P_ajouter_client ('FREYA 2', 'Le chat', 'rue du chat noir', 'Miaou', 33000, 'Bordeaux', false);
