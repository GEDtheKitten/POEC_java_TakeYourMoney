...
public class JDialogGestion extends JDialog {
	...
	public JDialogGestion(Connection connTakeYourMoney, String type) {
		super();
		this.conTYM = connTakeYourMoney;
		constructJDialog(type);
	}

	private JPanel constructPanel(String type) {
	...
	private void constructJDialog(String type) {
		setSize(800, 600);
		setTitle(type);
		setResizable(false);
